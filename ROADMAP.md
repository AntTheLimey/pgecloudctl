...
|------|--------|---------|--------|-------|--------|-------|
| Auth (login/status/logout) | 5 | 5 | S (1) | 15.0 | Planned | v0.1 — foundation for all commands |
| Clusters CRUD | 5 | 5 | M (2) | 7.5 | Planned | v0.1 — core resource |
| Databases CRUD | 5 | 5 | M (2) | 7.5 | Planned | v0.1 — core resource |
| Tasks list/get/wait | 5 | 5 | M (2) | 7.5 | Planned | v0.1 — async bridge for AI agents |
| OpenAPI client generation | 4 | 5 | M (2) | 6.5 | Planned | v0.1 — foundation for all API calls |
| Cloud accounts CRUD | 4 | 4 | M (2) | 6.0 | Planned | v0.1 — needed to create clusters |
| MCP server deploy/update | 4 | 4 | M (2) | 6.0 | Planned | v0.1 — key differentiator |
| RAG server deploy/update | 4 | 4 | M (2) | 6.0 | Planned | v0.1 — key differentiator |
| Database services list/get/remove | 4 | 4 | S (1) | 12.0 | Planned | v0.1 — service management |
| Table + JSON output | 5 | 5 | S (1) | 15.0 | Planned | v0.1 — AI agents need JSON |
| CI + linting + goreleaser | 4 | 4 | M (2) | 6.0 | Planned | v0.1 — pgEdge repo standards |
| Backups + backup stores | 3 | 3 | M (2) | 4.5 | Planned | v0.2 |
| SSH keys | 3 | 2 | S (1) | 8.0 | Planned | v0.2 |
| Ingresses + service registration | 4 | 3 | M (2) | 5.5 | Planned | v0.2 — enterprise service exposure |
| Invites + memberships | 3 | 2 | M (2) | 4.0 | Planned | v0.2 |
| Shares + templates | 2 | 2 | S (1) | 6.0 | Planned | v0.2 |
...
v0.2 and v0.3 items will move to Planned as v0.1 ships.

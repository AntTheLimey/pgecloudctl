...
type ClientInterface interface {
	...
	DeleteBackup(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetBackup request
	GetBackup(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetBackupLink request
	GetBackupLink(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	AcceptInvite(ctx context.Context, id UUID, params *AcceptInviteParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) DeleteBackup(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetBackupLink(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) AcceptInvite(ctx context.Context, id UUID, params *AcceptInviteParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewDeleteBackupRequest(server string, id UUID) (*http.Request, error) {
	var err error
...
func NewGetBackupLinkRequest(server string, id UUID) (*http.Request, error) {
	var err error
...
func NewListAvailabilityZonesRequest(server string, id UUID, region string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/cloud-accounts/%s/regions/%s/availability-zones", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewListIngressServicesRequest(server string, id UUID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/ingresses/%s/services", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteIngressServiceRequest(server string, id UUID, serviceId string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/ingresses/%s/services/%s", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewAcceptInviteRequest(server string, id UUID, params *AcceptInviteParams) (*http.Request, error) {
	var err error
	...
	if params != nil {
		...
		if queryFrag, err := runtime.StyleParamWithOptions("form", true, "invite_token", params.InviteToken, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
			return nil, err
		} else {
			for _, qp := range strings.Split(queryFrag, "&") {
				rawQueryFragments = append(rawQueryFragments, qp)
...
type ClientWithResponsesInterface interface {
	...
	DeleteBackupWithResponse(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*DeleteBackupResponse, error)
	...
	GetBackupLinkWithResponse(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*GetBackupLinkResponse, error)
	...
	AcceptInviteWithResponse(ctx context.Context, id UUID, params *AcceptInviteParams, reqEditors ...RequestEditorFn) (*AcceptInviteResponse, error)
...
func (r ListAvailableClustersResponse) ContentType() string {
	if r.HTTPResponse != nil {
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetBackupLinkResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
func (c *ClientWithResponses) DeleteBackupWithResponse(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*DeleteBackupResponse, error) {
...
func (c *ClientWithResponses) GetBackupLinkWithResponse(ctx context.Context, id UUID, reqEditors ...RequestEditorFn) (*GetBackupLinkResponse, error) {
...
func (c *ClientWithResponses) AcceptInviteWithResponse(ctx context.Context, id UUID, params *AcceptInviteParams, reqEditors ...RequestEditorFn) (*AcceptInviteResponse, error) {
